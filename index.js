...
(async()=>{
	const views = await getData('https://api.github.com/repos/nach131/Born2beroot/traffic/views');
	const clone = await getData('https://api.github.com/repos/nach131/Born2beroot/traffic/clones');
